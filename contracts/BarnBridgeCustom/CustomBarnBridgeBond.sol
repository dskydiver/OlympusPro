...
// File contracts/BarnBridgeCustom/CustomBarnBridgeBond.sol
...
contract CustomBondBarnBridge is Ownable {
    ...
    function _payoutFor( uint _value ) internal view returns ( uint ) {
        return FixedPoint.fraction( _value, bondPrice() ).decode112with18().div( 1e8 );
    }
